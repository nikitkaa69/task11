...
DROP DOMAIN IF EXISTS public."bıgınt" CASCADE;
DROP TYPE IF EXISTS public.mpaa_rating CASCADE;
DROP DOMAIN IF EXISTS public.year CASCADE;
DROP FUNCTION IF EXISTS public._group_concat(text, text) CASCADE;
DROP FUNCTION IF EXISTS public.film_in_stock(integer, integer) CASCADE;
DROP FUNCTION IF EXISTS public.film_not_in_stock(integer, integer) CASCADE;
DROP FUNCTION IF EXISTS public.get_customer_balance(integer, timestamp with time zone) CASCADE;
DROP FUNCTION IF EXISTS public.inventory_held_by_customer(integer) CASCADE;
DROP FUNCTION IF EXISTS public.inventory_in_stock(integer) CASCADE;
DROP FUNCTION IF EXISTS public.last_day(timestamp with time zone) CASCADE;
DROP FUNCTION IF EXISTS public.last_updated() CASCADE;
DROP FUNCTION IF EXISTS public.rewards_report(integer, numeric) CASCADE;
DROP AGGREGATE IF EXISTS public.group_concat(text) CASCADE;
